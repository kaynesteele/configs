...
static const char testfg[]          = "#ffffff";
static const char testbg[]          = "#ff0000";

static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray3, col_gray1, col_gray2 },
	[SchemeSel]  = { col_gray4, col_cyan,  testbg  },
	[TestScheme] = { testfg,    testbg,    testbg    },
};
